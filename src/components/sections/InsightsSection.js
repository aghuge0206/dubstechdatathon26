...
const INSIGHTS = [
  {
    ...
    evidence: "See Top 10 chart: Bisexual and Uninsured rank #1 and #2 respectively.",
  },
  {
    ...
    evidence: "Data: Medical 25.0%, Mental 13.6%, Medication 25.8%. See breakdown chart.",
  },
  {
    ...
    evidence: "National averages: Medication 7.8% > Medical 7.4% > Mental 5.9%.",
  },
];
          ...
          {INSIGHTS.map((insight, i) => (
            <AnimatedSection key={i} delay={i * 0.1}>
              <div className="card h-full flex flex-col">
                ...
                {insight.evidence && (
                  <p className="mt-4 pt-3 border-t border-slate-100 text-[11px] text-blue-600 font-medium">
                    {insight.evidence}
                  </p>
                )}
              </div>
