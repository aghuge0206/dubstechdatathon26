...
export function DataStatus({ isPlaceholder }) {
    ...
    return (
        <div className="inline-flex items-center gap-1.5 text-sm text-green-700 bg-green-50 px-3 py-1 rounded-full border border-green-200">
            <span>✓</span>
            <span>Final NHIS data loaded</span>
        </div>
    );
}
